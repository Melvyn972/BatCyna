        ...
        <div className="container">
          <div className="bg_grey-2 radius-10 flat-wrap-iconbox">
            <div className="flat-title lg">
              <span className="title fw-5">La qualité est notre priorité</span>
              <div>
                <p className="sub-title text_black-2">
                  Nos stylistes talentueux ont assemblé des tenues parfaites pour
                  la saison.
                </p>
                <p className="sub-title text_black-2">
                  Ils ont une variété de façons d'inspirer votre prochain look
                  à la mode.
                </p>
              </div>
            </div>
