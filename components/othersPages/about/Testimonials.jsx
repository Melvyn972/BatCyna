        ...
        <div className="container">
          <div className="wrapper-thumbs-testimonial-v2 flat-thumbs-testimonial">
            <div className="box-left">
              <Swiper
                  dir="ltr"
                  spaceBetween={40} // Espacement Swiper data-space-lg
                  breakpoints={{
                    768: { spaceBetween: 30 }, // Équivalent de Swiper data-space-md
                  }}
                  slidesPerView={1}
                ...
                {testimonials16.map((testimonial, index) => (
                    <SwiperSlide key={index}>
                      <div className="testimonial-item lg lg-2">
                        <h4 className="mb_40">Les avis de nos clients</h4>
                        <div className="icon">
                          <Image
            ...
            <div className="box-right">
              <Swiper
                  dir="ltr"
                  spaceBetween={30} // Correspond à data-space
                  slidesPerView={1}
