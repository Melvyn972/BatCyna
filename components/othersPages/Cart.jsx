      ...
      <div className="container">
        ...
        <div className="tf-cart-countdown">
          <div className="title-left">
            ...
            <p>Ces produits sont en quantité limitée, finalisez votre commande dans</p>
          </div>
          <div
          ...
          <div className="tf-page-cart-item">
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="tf-page-cart-note">
                <label htmlFor="cart-note">Ajouter une note à la commande</label>
                <textarea
                  name="note"
                  id="cart-note"
            ...
            <div className="tf-cart-footer-inner">
              <div className="tf-free-shipping-bar">
                ...
                <div className="tf-progress-msg">
                  Ajouter <span className="price fw-6">€75.00</span> pour profiter de la {" "}
              ...
              <div className="tf-page-cart-checkout">
                ...
                <div className="cart-checkbox">
                  ...
                  <span>Souhaitez-vous un emballage cadeau ?</span> Seulement  
                ...
                <p className="tf-cart-tax">
                   Taxes et  
                  <Link href={`/shipping-delivery`}>frais de livraison</Link> calculés  
                  lors du paiement
                ...
                <div className="tf-page-cart_imgtrust">
                  <p className="text-center fw-6">Paiement sécurisé garanti</p>
