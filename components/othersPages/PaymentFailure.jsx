            ...
            <div className="col-xl-4 col-lg-6 col-md-8">
              <div className="tf-page-cart-checkout">
                <div className="d-flex gap-10 align-items-center mb_20">
                  ...
                  <h5 className="fw-5">Échec du paiement</h5>
                </div>
                <p className="mb_20">
                  Bonjour. Nous avons essayé de débiter votre carte, mais quelque chose a mal tourné. Veuillez mettre à jour votre méthode de paiement ci-dessous pour continuer.
                </p>
                <Link
                    href={`/checkout`}
                    className="tf-btn mb_20 w-100 btn-fill animate-hover-btn radius-3 justify-content-center"
                >
                  <span>Mettre à jour la méthode de paiement</span>
                </Link>
                <p>
