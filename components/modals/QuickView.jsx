...
export default function QuickView() {
  ...
  const openModalSizeChoice = () => {
    const bootstrap = require("bootstrap"); // importation dynamique de bootstrap
    ...
    if (backdrops.length > 1) {
      // Appliquer le z-index au dernier fond
              ...
              <div className="tf-product-info-wrap position-relative">
                <div className="tf-product-info-list">
                  ...
                  <div className="tf-product-info-badges">
                    <div className="badges text-uppercase">Meilleure vente</div>
                    <div className="product-status-content">
                      <i className="icon-lightning" />
                      <p className="fw-6">
                        Vente rapide ! 48 personnes ont cela dans leur panier.
                      </p>
                    </div>
                  </div>
                  <div className="tf-product-info-price">
                    <div className="price">{(quickViewItem.price * 0.93).toFixed(2)} €</div>
                  </div>
                  ...
                  <div className="tf-product-info-buy-button">
                    <form onSubmit={(e) => e.preventDefault()} className="">
                      ...
                      <span>
                        ...
                        {(quickViewItem.price * 0.93).toFixed(2)} €
                      </span>
                      </a>
                      <a
