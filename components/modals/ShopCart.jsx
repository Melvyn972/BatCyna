      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="header">
            <div className="title fw-5">Panier d'achat</div>
            <span
          ...
          <div className="wrap">
            <div className="tf-mini-cart-threshold">
              ...
              Acheter <span className="price fw-6">€75.00</span> pour profiter de la
                <span className="fw-6"> Livraison gratuite</span>
              </div>
            </div>
              ...
              <div className="tf-mini-cart-bottom">
                ...
                <div className="tf-mini-cart-bottom-wrap">
                  <div className="tf-cart-totals-discounts">
                    <div className="tf-cart-total">Sous-total</div>
                    <div className="tf-totals-total-value fw-6">
                    €{totalPrice.toFixed(2)} EUR
                    </div>
                  </div>
                  <div className="tf-cart-tax">
                  Taxes et <a href="#">frais de livraison</a> calculés lors du paiement
                  </div>
                  ...
                  <div className="tf-mini-cart-tool-content">
                    <div className="tf-mini-cart-tool-text">
                      ...
                      <div className="tf-gift-wrap-infos">
                        <p>Souhaitez-vous un emballage cadeau ?</p>
                        Seulement 
                    ...
                    <div className="tf-cart-tool-btns">
                      ...
                      >
                        <span>Ajouter un emballage cadeau</span>
                      </button>
                      <div
                        className="tf-mini-cart-tool-primary text-center w-100 fw-6 tf-mini-cart-tool-close"
                        onClick={() =>
              ...
              >
                ...
                <div className="tf-mini-cart-tool-content">
                  <div className="tf-mini-cart-tool-text">
                    ...
                    <span className="fw-6">Estimer les frais de livraison</span>
                  </div>
                  <div className="field">
                    <p>Pays</p>
                    <select
