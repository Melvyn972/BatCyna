...
const categories = [
{ id: 1, name: "Mode", isActive: true, link: "/shop-default" },
{ id: 2, name: "Hommes", isActive: false, link: "/shop-men" },
{ id: 3, name: "Femmes", isActive: false, link: "/shop-women" },
{ id: 4, name: "Denim", isActive: false, link: "/shop-default" },
{ id: 5, name: "Robe", isActive: false, link: "/shop-default" },

];

const filterColors = [
  { name: "Orange", colorClass: "bg_orange-3" },
{ name: "Noir", colorClass: "bg_dark" },
{ name: "Blanc", colorClass: "bg_white" },
{ name: "Marron", colorClass: "bg_brown" },
{ name: "Violet clair", colorClass: "bg_purple" },
{ name: "Vert clair", colorClass: "bg_light-green" },
{ name: "Rose", colorClass: "bg_purple" },
{ name: "Bleu", colorClass: "bg_blue-2" },
{ name: "Bleu foncé", colorClass: "bg_dark-blue" },
{ name: "Gris clair", colorClass: "bg_light-grey" },
{ name: "Beige", colorClass: "bg_beige" },
{ name: "Bleu clair", colorClass: "bg_light-blue" },
{ name: "Gris", colorClass: "bg_grey" },
{ name: "Rose clair", colorClass: "bg_light-pink" },
];
const brands = ["CYNA Store", "M&H"];
const availabilities = [
  { id: 1, isAvailable: true, text: "Disponible", count: 14 },
  { id: 2, isAvailable: false, text: "Rupture de stock", count: 2 },
];
const sizes = ["S", "M", "L", "XL"];
import Slider from "rc-slider";
import { products6 } from "@/data/products";
import Link from "next/link";
export default function ShopFilter({ setProducts, products = products6 }) {
                  ...
                  {brands.map((brand) => (
                    ...
                    >
                      ...
                      <label className="label">
                        <span>{brand}</span>&nbsp;
                        <span>
                          ({products?.filter((elm) => elm?.brand === brand).length || 0}
                          )
                        </span>
                      </label>
                    </li>
