      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Protégez votre entreprise contre les <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">menaces cyber</span> en évolution
            </h2>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 max-w-3xl mx-auto">
          <div className="relative group w-full md:w-auto">
            ...
            <button className="relative w-full md:w-auto px-8 py-4 bg-black text-white font-medium rounded-full flex items-center justify-center gap-2 group-hover:bg-black/95 transition duration-200">
          ...
          <a href="#" className="w-full md:w-auto px-8 py-4 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white transition-all rounded-full font-medium text-center">
            Commencer gratuitement
          </a>
        </div>
        
        <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 text-center">
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 hover:bg-white/10 transition-all duration-300">
            <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center rounded-full bg-purple-500/20">
            ...
            <h3 className="text-lg font-semibold text-white mb-1">Facile à utiliser</h3>
            <p className="text-gray-400 text-sm">Interface intuitive conçue pour tous les niveaux</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 hover:bg-white/10 transition-all duration-300">
            ...
            <h3 className="text-lg font-semibold text-white mb-1">Alertes en temps réel</h3>
            <p className="text-gray-400 text-sm">Soyez informé immédiatement de toute menace</p>
          </div>
          
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 hover:bg-white/10 transition-all duration-300">
            <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center rounded-full bg-green-500/20">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 11V7C7 5.67392 7.52678 4.40215 8.46447 3.46447C9.40215 2.52678 10.6739 2 12 2C13.3261 2 14.5979 2.52678 15.5355 3.46447C16.4732 4.40215 17 5.67392 17 7V11M5 11H19C20.1046 11 21 11.8954 21 13V20C21 21.1046 20.1046 22 19 22H5C3.89543 22 3 21.1046 3 20V13C3 11.8954 3.89543 11 5 11Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-white mb-1">Sécurité renforcée</h3>
            <p className="text-gray-400 text-sm">Protégez vos données avec le chiffrement avancé</p>
              </div>
          
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 hover:bg-white/10 transition-all duration-300">
            <div className="w-12 h-12 mx-auto mb-4 flex items-center justify-center rounded-full bg-yellow-500/20">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-gray-400 text-sm">Une équipe d'experts à votre service en permanence</p>
          </div>
        </div>
      </div>
    </section>
